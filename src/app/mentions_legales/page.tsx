...
export const metadata: Metadata = {
  title: 'Mentions Légales - C.L.A.S.S.E. Conseil',
  description:
...
export default function Legals() {
  return (
    <section className={`section container legal_page ${styles.legals}`}>
      <h1 className="section_title">Mentions Légales</h1>
      <hr className="separator" />
      <h2 className={styles.sub_section_title}>Définitions</h2>
      <p>
        ...
        <a href="https://www.classe-conseil.fr/">
          https://www.classe-conseil.fr/
        </a>
      ...
      <p>
        <strong>Propriétaire</strong> : unipersonnel CLASSE CONSEIL CORINE
        PESIER – 48 RUE DE LA MAUGUETTE 33170 GRADIGNAN
        <br />
        <strong>Responsable publication</strong> : PESIER – clcconseil@aol.com
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Pesier – clconseil@aol.com
        <br />
        <strong>Hébergeur</strong> : Netlify – 2325 3rd Street, Suite 215 94107
        San Francisco NA
        <br />
        <strong>Délégué à la protection des données</strong> : Pesier –
        clconseil@aol.com
        <br />
      </p>
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : CLASSE CONSEIL
        CORINE PESIER.{' '}
        <a href="https://www.classe-conseil.fr/">
          https://www.classe-conseil.fr/
        </a>
        est représenté par PESIER, son représentant légal.
      </p>
      <p>
      ...
      <ul>
        <li>
          droit d&aposaccès (article 15 RGPD) et de rectification (article 16
      ...
      &nbsp; CLASSE CONSEIL CORINE PESIER – DPO, Pesier <br />
      48 RUE DE LA MAUGUETTE 33170 GRADIGNAN. &nbsp;
      <p>
      ...
      <h2 className={styles.sub_section_title}>8. Notification d’incident</h2>
      <p>
        ...
        situent au niveau national ou européen. Nous nous engageons à informer
        pleinement nos clients de toutes les questions relevant de la sécurité
        de leur compte et à leur fournir toutes les informations nécessaires
        pour les aider à respecter leurs propres obligations réglementaires en
      ...
      <p>
        ...
        tribunaux compétents de Bordeaux.
      </p>
    </section>
  );
}
